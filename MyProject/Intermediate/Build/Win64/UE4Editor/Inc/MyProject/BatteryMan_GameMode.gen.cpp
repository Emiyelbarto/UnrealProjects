...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ABatteryMan_GameMode_Statics::NewProp_Spawn_Y_Max = { "Spawn_Y_Max", nullptr, (EPropertyFlags)0x0040000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABatteryMan_GameMode, Spawn_Y_Max), METADATA_PARAMS(Z_Construct_UClass_ABatteryMan_GameMode_Statics::NewProp_Spawn_Y_Max_MetaData, ARRAY_COUNT(Z_Construct_UClass_ABatteryMan_GameMode_Statics::NewProp_Spawn_Y_Max_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ABatteryMan_GameMode_Statics::NewProp_Spawn_X_Max = { "Spawn_X_Max", nullptr, (EPropertyFlags)0x0040000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABatteryMan_GameMode, Spawn_X_Max), METADATA_PARAMS(Z_Construct_UClass_ABatteryMan_GameMode_Statics::NewProp_Spawn_X_Max_MetaData, ARRAY_COUNT(Z_Construct_UClass_ABatteryMan_GameMode_Statics::NewProp_Spawn_X_Max_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ABatteryMan_GameMode_Statics::NewProp_Spawn_X_Min = { "Spawn_X_Min", nullptr, (EPropertyFlags)0x0040000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABatteryMan_GameMode, Spawn_X_Min), METADATA_PARAMS(Z_Construct_UClass_ABatteryMan_GameMode_Statics::NewProp_Spawn_X_Min_MetaData, ARRAY_COUNT(Z_Construct_UClass_ABatteryMan_GameMode_Statics::NewProp_Spawn_X_Min_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ABatteryMan_GameMode_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_ABatteryMan_GameMode_Statics::PropPointers),
		0,
		0x009002ACu,
		METADATA_PARAMS(Z_Construct_UClass_ABatteryMan_GameMode_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_ABatteryMan_GameMode_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(ABatteryMan_GameMode, 1679707171);
